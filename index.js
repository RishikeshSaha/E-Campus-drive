...
const result = require('./routes/result-mgmt');
const timetable = require('./routes/timetable-mgmt');
const faculty = require('./routes/faculty-mgmt');
...
app.use('/result-management', result);
app.use('/timetable-management', timetable);
app.use('/faculty-management', faculty);
app.use('/api', api);
